...
import com.example.khalil.myrobot.LanguageConfig
 ...
 */
object Config {
    // keys from your developer dashboard
    val ACCESS_TOKEN = "b99aaea780704deb9b455dd830628a37"

    // this does not have to be languages.
    // It could be functions.
    val languages = arrayOf(LanguageConfig("en", "b99aaea780704deb9b455dd830628a37"),
    ...
    val events = arrayOf("current_location", "search")
}
